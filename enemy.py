...
def enemy_health_logic(screen):
    ...
    for enemy in enemies:
        ...
        for bullet in b.bullets:
            ...
            if (bullet[0][0] > enemy[0][0] and bullet[0][1] > enemy[0][1]) and (bullet[0][0]+b.bullet_size < enemy[0][0]+enemy_size[0] and bullet[0][1]+b.bullet_size < enemy[0][1]+enemy_size[1]):
